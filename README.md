...
You can find the re-training details [here]([https://github.com/eus-lwq/leximind/blob/dev_eric/pipeline/train_pipeline.md](https://github.com/eus-lwq/leximind/blob/main/.github/workflows/retrain.yml))
