...
| **CodeQA** | Java: 119,778<br>Python: 70,085 | [CodeQA](https://aclanthology.org/2021.findings-emnlp.223/) | Chenxiao Liu, Xiaojun Wan | A free-form question-answering dataset for source code comprehension, requiring textual answers based on code snippets. | Q: "What does the following Python function do?"<br>Code: `def add(a, b): return a + b`<br>A: "It adds two numbers and returns the result." | Includes Java and Python datasets. | Transformed code comments into Q&A pairs using syntactic rules and semantic analysis. | Typically used for research purposes; refer to the original publication for specific licensing details. |
